...
const classes = cvx({
  variants: {
    ...
    child: {
      default: "text-sm p-2 group-data-[side=top]:border-t group-data-[side=bottom]:border-b group-data-[side=left]:border-l group-data-[side=right]:border-r last-of-type:border-b-0 min-w-max",
