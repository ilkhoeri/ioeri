...
import { TRANSITIONS, VELOCITY_THRESHOLD } from "./types";
      ...
      if (setBackgroundColorOnScale) {
        if (!noBodyStyles) {
          ...
          set(
            document.body,
            {
              background: "hsl(var(--background-theme))",
            },
            true,
          );
        }
...
const Handle = React.forwardRef<HTMLDivElement, HandleProps>(function (
  ...
  function handleCancelInteraction() {
    ...
    // window.clearTimeout(closeTimeoutIdRef.current ?? undefined);
...
const Overlay = React.forwardRef<
  HTMLDivElement,
  React.ComponentPropsWithoutRef<typeof DialogPrimitive.Overlay> & SharedTypes
...
function NestedRoot({ onDrag, onOpenChange, ...rest }: DialogProps) {
  ...
  if (!onNestedDrag) {
    throw new Error("Sheet.NestedRoot must be placed in another drawer / sheet");
  }
...
const Trigger = React.forwardRef<
  ...
  React.ComponentPropsWithoutRef<typeof DialogPrimitive.Trigger> & SharedTypes
>(({ ...props }, ref) => <DialogPrimitive.Trigger ref={ref} {...props} />);
Trigger.displayName = DialogPrimitive.Trigger.displayName;

const Close = React.forwardRef<
  React.ElementRef<typeof DialogPrimitive.Close>,
  React.ComponentPropsWithoutRef<typeof DialogPrimitive.Close> & SharedTypes
>(({ ...props }, ref) => <DialogPrimitive.Close ref={ref} {...props} />);
Close.displayName = DialogPrimitive.Close.displayName;

const Title = React.forwardRef<
  React.ElementRef<typeof DialogPrimitive.Title>,
  React.ComponentPropsWithoutRef<typeof DialogPrimitive.Title> & SharedTypes
>(({ ...props }, ref) => <DialogPrimitive.Title ref={ref} {...props} />);
Title.displayName = DialogPrimitive.Title.displayName;

const Description = React.forwardRef<
  React.ElementRef<typeof DialogPrimitive.Description>,
  React.ComponentPropsWithoutRef<typeof DialogPrimitive.Description> & SharedTypes
>(({ ...props }, ref) => <DialogPrimitive.Description ref={ref} {...props} />);
Description.displayName = DialogPrimitive.Description.displayName;

const Indicator = React.forwardRef<
  HTMLSpanElement,
  React.DetailedHTMLProps<React.HTMLAttributes<HTMLElement>, HTMLElement> & SharedTypes
>(({ ...props }, ref) => (
  <span ref={ref} role="button" aria-label="sheet indicator" data-sheet="indicator" {...props} />
));
