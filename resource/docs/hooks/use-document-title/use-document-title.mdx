$:consideration-use-document-title
...
$:explanation-use-document-title
...
- Go for a longer, descriptive title (avoid one- or two-word titles). [`mdn`](https://developer.mozilla.org/en-US/docs/Web/HTML/Element/title)
