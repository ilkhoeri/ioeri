...
>(({ className, children, ...props }, ref) => (
  <SelectPrimitive.Trigger
    ref={ref}
    className={twMerge(
      "flex h-9 w-full items-center justify-between whitespace-nowrap rounded-md border border-input bg-transparent px-3 py-2 text-sm shadow-sm ring-offset-background placeholder:text-color text-color focus:outline-none focus:ring-1 focus:ring-ring disabled:cursor-not-allowed disabled:opacity-50 [&>span]:line-clamp-1",
      className,
    )}
    {...props}
  >
...
const ResetSelect = React.forwardRef<
  HTMLButtonElement,
  React.ButtonHTMLAttributes<HTMLButtonElement> & SelectValueType
>(({ className, value, type, ...props }, ref) => {
  ...
  return (
    <button
      ...
      {...props}
      className={twMerge(
        "font-medium relative flex w-full cursor-pointer select-none items-center justify-start text-left rounded-sm py-1.5 pl-8 pr-2 text-sm outline-none focus:text-accent-foreground data-[disabled]:pointer-events-none data-[disabled]:opacity-50",
        value ? "bg-[#ff5555]" : "focus:bg-muted",
        className,
      )}
    >
      <svg
...
ResetSelect.displayName = "ResetSelect";
