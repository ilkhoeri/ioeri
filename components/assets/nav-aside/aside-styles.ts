...
const Styles = cvx({
  variants: {
    style: {
      ...
      nav: "relative flex items-start justify-start flex-col flex-nowrap size-full pl-4 pr-1.5 max-md:pb-24 max-md:pt-0 overflow-y-auto overflow-x-hidden webkit-scrollbar",
      overlay:
