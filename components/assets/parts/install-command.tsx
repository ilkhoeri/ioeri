      ...
      <div className="py-8 px-4 overflow-hidden relative border rounded-xl bg-subtle bg-muted/40 backdrop-blur">
        <div className="flex flex-col gap-4 relative z-10">
          <div className="font-mono flex flex-col mb-4 last:mb-0">
            ...
            <pre className="relative rounded-b-md overflow-x-auto webkit-scrollbar p-4 pr-2 leading-[19px] text-color bg-background border border-transparent whitespace-nowrap flex flex-col">
